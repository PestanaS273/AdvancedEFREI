    ...
    <table class="min-w-full border-collapse">
      ...
      <tbody>
        ...
        >
          ...
          <td><RouterLink :to="{ name: 'collection-feedback', params: { id: survey.id}}" class="text-sm font-medium text-gray-600 uppercase" @click="setCollectionForm(survey)">{{ t('Review Answers')}}</RouterLink></td>
        </tr>
      </tbody>
    </table>
  </div>
